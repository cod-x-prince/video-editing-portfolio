...
import { Play, Mail, Calendar, Upload, Check } from "lucide-react";
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold font-syne tracking-tight leading-tight mb-8">
            {HERO_COPY.split(" ").map((word, i) => (
              <span key={i} className="inline-block mr-[0.2em] relative group">
                {word}
        ...
        <div className="container mx-auto px-6">
          <div className="mb-16 text-center max-w-3xl mx-auto">
            ...
            <p className="text-neutral-400 text-lg">
              Clear monthly retainers. No hidden fees. Pause or cancel anytime.
            </p>
          </div>
          ...
          <div className="mt-12 text-center text-sm text-neutral-500 max-w-2xl mx-auto">
            ...
            <p className="italic opacity-60">
              * Social media management (posting, scheduling, engagement) is not
              included.
            </p>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <a
                href="mailto:hello@addictive.edit"
        ...
        <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center text-sm text-neutral-500">
          ...
          <div className="flex items-center gap-6 mt-4 md:mt-0">
            ...
            <button
              ...
              className="flex items-center gap-2 text-neutral-600 hover:text-white transition-colors ml-4 border-l border-neutral-800 pl-4"
            >
              <Upload size={14} /> Client Access
            </button>
          </div>
        </div>
      </footer>
